      ...
      <Transition.Root show={open} as={Fragment}>
        ...
        >
          ...
          >
            ...
            >
              <div className="inline-block align-bottom bg-gray-200 rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-sm sm:w-full sm:p-6">
                <form
                  id="modalForm"
                  onSubmit={(e) => {
                    e.preventDefault();
